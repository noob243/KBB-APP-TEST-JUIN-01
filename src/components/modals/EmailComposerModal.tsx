...
const EmailComposerModal: FC<EmailComposerModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-xs z-55 flex justify-center items-center p-4">
        ...
        <div className="bg-indigo-900 px-6 py-4 flex justify-between items-center text-white">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-indigo-200">cabinet.kbb@law.cd • Serveur de messagerie sécurisé</p>
            </div>
          </div>
          <button 
            onClick={onClose} 
